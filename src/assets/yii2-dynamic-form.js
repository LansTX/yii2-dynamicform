...
(function($) {
  ...
  var _parseTemplate = function(widgetOptions) {
    ...
    if (
      typeof yiiActiveFormData !== "undefined" &&
      typeof yiiActiveFormData.settings !== "undefined"
    ) {
      if (
        typeof yiiActiveFormData.settings.errorCssClass !== "undefined" &&
        yiiActiveFormData.settings.errorCssClass.length > 0
      ) {
        $template
      ...
      if (
        typeof yiiActiveFormData.settings.successCssClass !== "undefined" &&
        yiiActiveFormData.settings.successCssClass.length > 0
      ) {
        $template
  ...
  var _getWidgetOptionsRoot = function(widgetOptions) {
    return eval(
      $("." + widgetOptions.widgetContainer + " " + widgetOptions.widgetBody)
  ...
  var _addItem = function(widgetOptions, e, $elem) {
    ...
    if (count < widgetOptions.limit) {
      ...
      $newclone.find(".remover-al-clonar").remove();
  ...
  var __distinctRecursive = function(regex, $item) {
    ...
    $.each($items, function(i, item) {
      ...
      $(item)
        .find(widgetItem + ":not(:nth-child(1))")
        .remove();
  ...
  var _updateAttributes = function(widgetOptions) {
    ...
    $(
      "." +
        widgetOptionsRoot.widgetContainer +
        " " +
        widgetOptionsRoot.widgetItem
    ).each(function(index) {
      var $item = $(this);
  ...
  var _restoreSpecialJs = function(widgetOptions) {
    ...
    var $hasDateTimepicker = $(widgetOptionsRoot.widgetItem).find(
      "[data-krajee-kvdatetimepicker]"
    );
    ...
    var $hasTypehead = $(widgetOptionsRoot.widgetItem).find(
      "[data-krajee-typeahead]"
    );
    ...
    var $hasCheckboxX = $(widgetOptionsRoot.widgetItem).find(
      "[data-krajee-checkboxx]"
    );
    ...
    var $hasRating = $(widgetOptionsRoot.widgetItem).find(
      "[data-krajee-rating]"
    );
